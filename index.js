...
// Connect to PostgreSQL (Host,User,Password and Database are read from the .env file.)
const sql = postgres();

// Connect to PostgreSQL with username and password and host manually configured
// const sql = postgres(
